...
// FIX: Import useState, useEffect, and useCallback from React to fix 'Cannot find name' errors. The original line also had a syntax error (a stray comma).
...
`,
      ...
      'sw.js': `const CACHE_NAME = 'ai-app-cache-v1';
const urlsToCache = [
  '/',
  '/index.html',
  '/style.css',
